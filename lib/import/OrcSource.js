...
const CACHE_REFRESH_TIMEOUT_MS = 30000
const CERTIFICATE_FETCH_TIMEOUT_MS = 10000
...
class OrcSource {
  ...
  async importByExternalId(externalId) {
    ...
    const certificateHtml = await this.fetchText(`${CERTIFICATE_URL_PREFIX}${entry.dxtId}`, `ORC certificate ${entry.dxtId}`, CERTIFICATE_FETCH_TIMEOUT_MS)
    return {
